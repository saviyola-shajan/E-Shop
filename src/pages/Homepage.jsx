...
const newArrivals = [
  ...
  {
    image: "https://cdn.builder.io/api/v1/image/arandssets/TEMP/b6a19ca0e4a258529a1a23530e795b35cacd0cf6e6e1fc0c7f2057d6f121bd08?placeholderIfAbsent=true&apiKey=c52adf39d782452a98f75530051b6cbf",
...
const Homepage = () => {
  return (
    <Layout>
      <Hero />
      <Brand />
      <Grid title="NEW ARRIVALS" products={newArrivals} />
      <Grid title="TOP SELLING" products={topSelling} />
      <MainComp />
      <Grid title="BEST SELLING" products={topSelling} />
      <Banner />
      <Instagram />
      <Signup />
      <Testimonial />
